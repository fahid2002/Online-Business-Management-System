...
public class ViewUsersFrame extends JFrame {
    ...
    public ViewUsersFrame() {
        setTitle("🌙 Twilight Thread - Customer List");
    ...
    private void initUI() {
        ...
        // Table
        String[] columns = {"UserID", "Username", "Email", "Phone"};
    ...
    private void populateTable(DefaultTableModel model) {
        try (Connection conn = Conn.getConnection();
             ...
             ResultSet rs = stmt.executeQuery("SELECT UserID, Username, Email, PhoneNumber FROM Users")) {
